...
CREATE TABLE IF NOT EXISTS `projet4`.`Localisation` (
  ...
  `Client_num_client` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Localisation_Client1_idx` (`Client_num_client` ASC),
  CONSTRAINT `fk_Localisation_Client1`
    FOREIGN KEY (`Client_num_client`)
...
CREATE TABLE IF NOT EXISTS `projet4`.`Commande` (
  ...
  `date_commande` TIMESTAMP(2) NOT NULL,
